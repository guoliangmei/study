...
public class OrderClient {
	...
	public static ExecutorService oneOrderOneSkuExecutor  = new ThreadPoolExecutor(
			oneOrderOneSku,     //core
			oneOrderOneSku, 	//max
			120L, 	//2分钟
			TimeUnit.SECONDS,
	...
	public static ExecutorService oneOrderManySkuExecutor  = new ThreadPoolExecutor(
